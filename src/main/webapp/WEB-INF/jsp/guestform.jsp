...
<div>
	<form method="POST" action="/guestupload" enctype="multipart/form-data" id="usrform" >
...
<c:forEach items="${imagejsonpi}" var="person">
        <div class="gallery" >    
            <a target="_blank" href="/analyticsdetails?imagename=${person.imagename}&username=<%=session.getAttribute("currentuser")%>">
              <img src="./images/${person.imagename}" alt="face" width="100%" height="100%">
            </a>
                       
         <!--   <a href="/favsave?username=<%=session.getAttribute("currentuser")%>&imagename=${person.imagename}">favorite</a> -->
       </div>     
    </c:forEach>
